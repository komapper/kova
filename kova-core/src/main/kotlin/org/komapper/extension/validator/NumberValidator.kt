...
public fun<T : Number> T.ensurePositive(message: MessageProvider = { "kova.number.positive".resource }) =
...
@IgnorableReturnValue
context(_: Validation)
public fun<T : Number> T.ensureNegative(message: MessageProvider = { "kova.number.negative".resource }) =
...
@IgnorableReturnValue
context(_: Validation)
public fun<T : Number> T.ensureNotPositive(message: MessageProvider = { "kova.number.notPositive".resource }) =
...
@IgnorableReturnValue
context(_: Validation)
public fun<T : Number> T.ensureNotNegative(message: MessageProvider = { "kova.number.notNegative".resource }) =
