 ...
 */
fun <C : Collection<*>> CollectionValidator<C>.notEmpty(message: MessageProvider = { "kova.collection.notEmpty".resource }) =
...
) = constrain { satisfies(it.contains(element), message) }
