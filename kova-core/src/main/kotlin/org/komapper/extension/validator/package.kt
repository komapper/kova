/**
 * Kova - A type-safe Kotlin validation library with context-based validators.
 *
 * ## Overview
 *
 ...
 * ```
 *
 * @see tryValidate Entry point for validation
 * @see ValidationResult Result of validation operations
 * @see Schema Schema-based object validation
 */
