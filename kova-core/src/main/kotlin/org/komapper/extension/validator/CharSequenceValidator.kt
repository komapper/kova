...
): T = apply { constrain("kova.charSequence.length") { satisfies(it.length == length, message) } }
...
): T = apply { constrain("kova.charSequence.lengthAtLeast") { satisfies(it.length >= length, message) } }
...
): T = apply { constrain("kova.charSequence.lengthAtMost") { satisfies(it.length <= length, message) } }
...
): T = apply { constrain("kova.charSequence.startsWith") { satisfies(it.startsWith(prefix, ignoreCase = false), message) } }
...
): T = apply { constrain("kova.charSequence.endsWith") { satisfies(it.endsWith(suffix, ignoreCase = false), message) } }
...
): T = apply { constrain("kova.charSequence.notEndsWith") { satisfies(!it.endsWith(suffix, ignoreCase = false), message) } }
...
): T = apply { constrain("kova.charSequence.contains") { satisfies(infix in it, message) } }
...
): T = apply { constrain("kova.charSequence.notContains") { satisfies(infix !in it, message) } }
...
): T = apply { constrain("kova.charSequence.matches") { satisfies(pattern.matches(it), message) } }
...
): T = apply { constrain("kova.charSequence.notMatches") { satisfies(!pattern.matches(it), message) } }
