...
): T = constrain("kova.charSequence.length") { satisfies(it.length == length, message) }
...
): T = constrain("kova.charSequence.lengthAtLeast") { satisfies(it.length >= length, message) }
...
): T = constrain("kova.charSequence.lengthAtMost") { satisfies(it.length <= length, message) }
...
public fun <T : CharSequence, R> T.ensureLengthInRange(
    ...
    constrain("kova.charSequence.lengthInRange") { satisfies(it.length in range, message) }
...
@IgnorableReturnValue
context(_: Validation)
public fun <T : CharSequence> T.ensureNotBlank(message: MessageProvider = { "kova.charSequence.notBlank".resource }): T =
...
@IgnorableReturnValue
context(_: Validation)
public fun <T : CharSequence> T.ensureBlank(message: MessageProvider = { "kova.charSequence.blank".resource }): T =
...
@IgnorableReturnValue
context(_: Validation)
public fun <T : CharSequence> T.ensureNotEmpty(message: MessageProvider = { "kova.charSequence.notEmpty".resource }): T =
...
@IgnorableReturnValue
context(_: Validation)
public fun <T : CharSequence> T.ensureEmpty(message: MessageProvider = { "kova.charSequence.empty".resource }): T =
...
): T = constrain("kova.charSequence.startsWith") { satisfies(it.startsWith(prefix, ignoreCase = false), message) }
...
): T = constrain("kova.charSequence.endsWith") { satisfies(it.endsWith(suffix, ignoreCase = false), message) }
...
): T = constrain("kova.charSequence.notEndsWith") { satisfies(!it.endsWith(suffix, ignoreCase = false), message) }
...
): T = constrain("kova.charSequence.contains") { satisfies(infix in it, message) }
...
): T = constrain("kova.charSequence.notContains") { satisfies(infix !in it, message) }
...
): T = constrain("kova.charSequence.matches") { satisfies(pattern.matches(it), message) }
...
): T = constrain("kova.charSequence.notMatches") { satisfies(!pattern.matches(it), message) }
